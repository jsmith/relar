...
export const BetaGuide = () => {
  return (
    <div className="px-8 mx-auto max-w-3xl text-gray-800 w-full py-5 beta-guide overflow-y-auto min-h-0">
      ...
      <H2 l="Your Role" />
      <P>
        As beta testers, getting your feedback is incredibly important so that I know what features
        to prioritize and can fix existing bugs. Once logged in, navigate to the account dropdown in
        the top right corner and click "Feedback". From there, you can file your feature request,
        bug report or provide other general feedback. Alternatively, contact me at{" "}
        <span className="font-bold">contact@relar.app</span> or sign up for the{" "}
      ...
      <H2 l="Limitations" />
      <P>
        There are several known limitations of the current system that I'll list below. Don't worry
        though, by the time app is actually released, these will all be resolved :)
      </P>
      <ul className="mt-2">
